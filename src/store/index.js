...
exports.UPDATE_NAME = exports.UPDATE_LOGO = exports.UPDATE_CONTRACTADDR = exports.UPDATE_CHAINID = exports.UPDATE_ACCOUNT = void 0;
...
exports.UPDATE_LOGO = "update-logo";
exports.UPDATE_NAME = "update-name";
var InvoiceStore = /** @class */ (function (_super) {
    ...
    function InvoiceStore() {
        ...
        return _super.call(this, {
            ...
            mutations: (_a = {},
                ...
                _a[exports.UPDATE_LOGO] = function (state, logo) {
                    state.logo = logo;
                },
                _a[exports.UPDATE_NAME] = function (state, name) {
                    state.name = name;
                },
                _a)
        }) || this;
    ...
    InvoiceStore.prototype.init = function (state) {
        ...
        this.commit(exports.UPDATE_LOGO, state.logo);
        this.commit(exports.UPDATE_NAME, state.name);
    };
    return InvoiceStore;
